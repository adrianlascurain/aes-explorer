...
import './MultiplicationSummaryTable.css'
import PolynomialExp from './PolynomialExp';
import VisualMultiplication from './VisualMultiplication';

function MultiplicationSummaryTable({g1Row,g1Col,g1Value,g2Row,g2Col,g2Value,hexTitle,binaryTitle,polynomialTitle, g1Img, g2Img} : {g1Row: number,g1Col: number, g1Value: number,g2Row: number,g2Col: number, g2Value: number, hexTitle: string, binaryTitle: string, polynomialTitle: string,g1Img: string, g2Img: string}){
        ...
        <div className='mst-matrix-multiplication-container'>
            ...
            <table className="mst-multiplication-resume-table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <figure className='mst-table-icon-figure'>
                                <img src={g1Img} alt="" />
                            </figure>
                        </td>
...
export default MultiplicationSummaryTable;